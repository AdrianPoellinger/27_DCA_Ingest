...
def analyse_format_over_time(csv_path, format_name, output_dir=None, show_plot=True):
...
if __name__ == "__main__":
    ...
    analyse_format_over_time(args.input, args.format, args.output, not args.no_show)
